...
const filteredMovies = data.filter((el) => el.type === "movie");
const filteredCartoons = data.filter((el) => el.type === "cartoon");
const filteredShows = data.filter((el) => el.type === "show");

console.log(filteredMovies);
console.log(filteredCartoons);
console.log(filteredShows);

const displayMoviesCards = () => {
...
const displayShowCards = () => {
  filteredShows.map((el) => {
    cardsShows.innerHTML += `
  <div class="card" style="background-image: url(${el.image})">
  <div class="card__container_opacity">
    <div class="card__container_top-space">
      <div class="rating-container">
...
const displayCartoonsCards = () => {
  filteredCartoons.map((el) => {
    cardsCartoons.innerHTML += `
  <div class="card" style="background-image: url(${el.image})">
  <div class="card__container_opacity">
    <div class="card__container_top-space">
      <div class="rating-container">
